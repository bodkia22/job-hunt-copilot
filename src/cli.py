...
def main() -> None:
    ...
    with open("output/cover_letter.txt", "w", encoding="utf-8") as file:
        file.write(cover_letter)
    print(f"\n(saved to cover_letter.txt)")

    save_application(vacancy_model.company_name, vacancy_model.position_title, match_result.match_percentage, match_result.is_good_fit, cover_letter)
